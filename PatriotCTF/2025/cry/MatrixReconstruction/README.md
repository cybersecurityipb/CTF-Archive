...
Karena dari deskripsi kita dikasih tahu bahwa "The keystream bytes come from the lowest byte of each internal state. Pay attention to the details.", dan kita dapat 40 internal states, dan ketika kita coba reconstruct keystreamnya dari leaked_keystream ini cukup untuk recover flag dan diperoleh format flag, maka here we go, ga perlu diapa-apain, tinggal xor aja.
