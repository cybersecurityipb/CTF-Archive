...
Singkat cerita, perlu kita curiga, ada file yg belum kita pakai yakni secret_blob.bin kemungkinan ini encrypted flag, tapi gimana cara decrypt nya pakai d? singkat cerita dukun, let gemini cook, dan gemini menebak ini adalah xor with keystream, beliau menebak XOR-SHA256-CTR, dimana 
